...
|---|---|
| **Version (Git)** | `1c21d60` |
| **Full SHA** | `1c21d60d135d7a23bd3d364eafe0dd6b2c47c234` |
| **Branch** | `main` |
...
**Pre-built EXE:** download the **Peterhack** artifact from [GitHub Actions](https://github.com/bowlingball3525/Meccha-Chameleon-Peterhack/actions) after a push to `main` (build `1c21d60` or newer).
...
| ESP shows only clones | Update to `ecb4120`+ (features from `fff8094`) |
...
| `RecursionError` in log | Fixed in `fff8094` — pull `ecb4120`+ and restart |
